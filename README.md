...
LayerToolsData processingpandas, numpyCollaborative filteringimplicit (ALS), scipy sparse matricesContent-based filteringscikit-learn (cosine similarity)Web appStreamlitLanguagePython 3.13
...
bashgit clone https://github.com/Ocean1407/ShopSense.git
cd ShopSense
...
bashjupyter notebook notebooks/01_eda.ipynb
...
ModelApproachUse caseCollaborativeALS, 50 factors, 20 iterationsExisting users with rating historyContent-BasedCosine similarity on user-product matrixProduct-to-product similarityHybrid50/50 normalized weighted blendBest overall recommendationsCold StartContent-based on manual inputBrand new users
